...
class _WorkoutsPageState extends State<WorkoutsPage> {
  ...
  List<Workout> get _filteredWorkouts {
    return _workouts.where((w) {
      final matchesSearch = w.type.toLowerCase().contains(
        _search.toLowerCase(),
      );
      final matchesDate =
          _selectedDate == null ||
                ...
                return Theme(
                  data: Theme.of(context).copyWith(
                    colorScheme: ColorScheme.light(
                      primary:
                          AppColors.primary, // цвет верхней панели и выделения
                      onPrimary:
                          AppColors.textAlternative, // цвет текста на панели
                      surface:
                          AppColors.backgroundComplimentary, // фон календаря
