          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.symmetric(horizontal: 20.0,vertical: 20),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children:  [
                  _menuCard(icon: FontAwesomeIcons.gear, title: 'Настройки'),
                  SizedBox(height: 10,)
                ],
              ),
              ),
      ...
      padding: const EdgeInsets.symmetric(horizontal:16.0 ,vertical: 14.0),
        ...
        children: [
          Row(
            children: [
              Container(
                padding: const EdgeInsets.symmetric(vertical: 4.8,horizontal: 10),
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                ),
                child: FaIcon(icon, color: AppColors.primary, size: 20),
  ...
  Widget _infoRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(label, style: TextStyle(color: Colors.white70, fontSize: 15.sp,  fontFamily: 'Gilroy', fontWeight: FontWeight.w400)),
          Text(value, style: TextStyle(color: Colors.white, fontSize: 15.sp, fontWeight: FontWeight.w700, fontFamily: 'Gilroy')),
        ],
      ),
    );
  }
